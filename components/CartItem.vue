        ...
        <div class="overflow-hidden pl-2 w-full">
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center justify-between truncate">
                    <span class="sm:block hidden bg-[#FD374F] text-white text-[9px] font-semibold px-1.5 roudned-sm min-w-[80px]">Delicious Foods</span>
                    <div class="truncate sm:pl-2">{{ menu.title }}</div>
                </div>
            ...
            <div class="text-xl font-semibold">
                SR <span class="font-bold">{{ menu.price / 100 }}</span>
            </div>

            <p class="text-[#009A66] text-xs font-semibold pt-1">
                Minimum of 15mins to 30mins delivery
            </p>
...
const props = defineProps(['menu', 'selectedArray'])
const { menu, selectedArray } = toRefs(props)
